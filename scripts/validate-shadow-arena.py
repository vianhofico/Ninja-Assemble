#!/usr/bin/env python3
"""Static contract checks for M32 playable Shadow Arena."""
...
def main() -> int:
    ...
    require("server/src/main/java/com/ninjaassemble/pvp/application/ShadowArenaApplicationService.java",
            ...
            "bo3-hp-power-tiebreak-v1", "TOTAL_HP", "SQUAD_POWER", "Currency.SHADOW_COIN",
    ...
    print("PLAYABLE_SHADOW_ARENA_OK eligibility=15 squads=3x5 wins=2 training_fallback=yes tiebreak=hp>power")
    return 0
